  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundColor: 'var(--color-debug-bg)',
      }}
    >
      {hasHighLatency && (
      ...
      <div className="flex flex-wrap items-center gap-2">
        <span className="font-semibold text-[var(--color-subtle)]">Latency</span>
      ...
      {rolling.sampleCount > 0 && (
        <div className="mt-1 flex flex-wrap items-center gap-2">
          ...
          <LatencyTag
            ...
            rating={p95Rating}
          />
          <span className="text-[var(--color-subtle)]">(n={rolling.sampleCount})</span>
        </div>
      )}
    </div>
  );
